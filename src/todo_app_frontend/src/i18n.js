 ...
 *
 * 辞書は 画面ごとに 別ファイルへ 分けてある（core / drill / drill-word / shogi / sky / asobi）。
...
import { drillWordEn, drillWordJa } from "./i18n-drill-word";
...
const DICT = {
  en: { ...coreEn, ...drillEn, ...drillWordEn, ...shogiEn, ...skyEn, ...asobiEn },
  ja: { ...coreJa, ...drillJa, ...drillWordJa, ...shogiJa, ...skyJa, ...asobiJa },
};
