...
そらの 見まわし・ちかづく・星を 押して 名前が 出ること・出すものの 切り替え・時間送り まで、
**166 項目**を 実ブラウザで 確かめます。

画面が なくても できる 検算（node）は **104 項目**です。
しょうぎの きまり 25／あいて 11／終わりかた 39、そらの 計算 29。
